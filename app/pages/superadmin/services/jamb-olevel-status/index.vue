...
const handleApprove = async () => {
  ...
  try {
    await $api(
      `/services/jamb-upload-status/${currentApproveId.value}/approve`,
      { method: 'POST' }
    )
...
<template>
 ...
 <!-- ✅ GREEN NUMBERING -->
    ...
    <Modal
      ...
      @ok="handleApprove"
    >
      <p>Are you sure you want to approve this JAMB Olevel Status request?</p>
...
.upload-table :deep(.ant-table-row:hover > td) {
  @apply bg-emerald-50;
}
