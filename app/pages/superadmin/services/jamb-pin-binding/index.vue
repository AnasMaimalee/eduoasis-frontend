...
<template>
  <div class="p-6 space-y-6 bg-emerald-50">
      ...
      >
        ...
        <template #fileCell="{ record }">
           <Button
              ...
              @click="downloadFile({ 
                id: record.id,
                url: `/services/jamb-pin-binding/${record.id}/download`,
                defaultFilename: 'jamb-pin-binding',
                successMessage: 'Admission PIN Binding downloaded',
              })"
            >
              📥 Download
            </Button>
    ...
    <Modal
      ...
      @ok="handleApprove"
    >
      <p>Are you sure you want to approve this JAMB PIN Binding request?</p>
