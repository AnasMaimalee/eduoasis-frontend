...
// ✅ SAME composable - just different service slug
const {
  pendingJobs,
  processingJobs,
  completedJobs,
  ...
  completeJob,
  beforeUpload
} = useServiceJobs('jamb-admission-status')
...
<template>
  <div class="p-6 space-y-8 bg-emerald-50">
    ...
    <Tabs v-model:activeKey="activeTab">
      <!-- PENDING - ServiceJobsTable handles admission columns -->
    ...
    <UploadResultModal
      ...
      serviceLabel="Admission Status Result"
